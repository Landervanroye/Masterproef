function [ps ] = create_problem_struct(deltat, buckets )
%CREATE_PROBLEM_STRUCT Summary of this function goes here
...
L = 1;
N = buckets; % N is het aantal gridcells
...
ps.T = T;
ps.db = db;
ps.MC_discr = MC_discr;
ps.problem = problem;
ps.debdiscr = debdiscr;
ps.xdiscr = xdiscr;
end
